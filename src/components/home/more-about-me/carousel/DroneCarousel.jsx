...
const DroneCarousel = () => {
  ...
  const images = [
    "/carousel/drone/c1.JPEG",
    "/carousel/drone/c2.JPEG",
    "/carousel/drone/c3.JPEG",
    "/carousel/drone/c4.jpg",
    "/carousel/drone/c5.JPEG",
    "/carousel/drone/c6.JPEG",
    "/carousel/drone/c7.jpg"
  ];
            ...
            >
              {images.map((src, index) => (
                ...
                >
                  <img
                    src={src}
                    alt={`Drone photography slide ${index + 1}`}
