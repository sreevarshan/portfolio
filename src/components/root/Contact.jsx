  ...
  return (
    <div className="isolate bg-white dark:bg-gray-800 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center justify-center">
        ...
        Have a question or want to collaborate? Feel free to reach out! Whether it’s about work opportunities, projects, or just a tech chat, I’d love to connect.
        </p>
        <div className="flex flex-col items-center justify-center gap-4 pt-15">
          ...
          <div>
            <h3 className="text-lg/tight font-medium text-gray-900 dark:text-gray-400">
              Mail
            </h3>
